...
public final class MessengerService {
  ...
  private MessengerService(IntaveBungeeProxySupportPlugin plugin, ConfigurationNode configuration) {
    this.plugin = plugin;
  ...
  public static MessengerService createFrom(IntaveBungeeProxySupportPlugin proxySupportPlugin, ConfigurationNode configuration) {
